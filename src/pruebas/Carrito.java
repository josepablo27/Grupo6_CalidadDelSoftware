...
public class Carrito {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String producto_seleccionado = driver.findElement(By.className("product-information")).findElement(By.tagName("h2")).getText();
		...
		String producto_guardado = driver.findElement(By.className("cart_description")).findElement(By.tagName("a")).getText();
		...
		System.out.println("Cantidad previa dentro del carrito: " + cantidad_carrito + "\n\n"
							...
							+ "Cantidad seleccionada:" + cantidad_seleccionada + "\n\n"
